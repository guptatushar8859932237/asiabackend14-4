...
export default function Editpdfclearance() {
  ...
  const handlepostvalue =async () => {
          ...
          console.log(data12)
        await  axios.post(`${process.env.REACT_APP_BASE_URL}calculateClearanceByAdmin`, data12).then((response) => {
        ...
        <div className="mt-4">
          <div>
            <div className="d-flex justify-content-between align-items-end mb-3">
              ...
              <div>
                <button className="btn btn-secondary" onClick={handleclickopenbutton}>Add Extra charges</button>
              </div>
            </div>
                ...
                <tbody className="esti_tbody">
                  ...
                  <tr>
                    <td colSpan="10" className="text-end">
                      <strong>Total  Amount: </strong> {finalAmount123333}<br />
                      <strong>Document Fee: </strong> {rows[0]?.document_fee}<br />
                      <strong>Import VAT: </strong> {rows[0]?.import_vat}<br />
                      {/* <strong>Import VAT: </strong> {finalAmount123333}<br /> */}
                      <strong>Customs Duty: </strong> {rows[0]?.customs_duty}<br />
                      <strong>Agency Surcharge: </strong> {rows[0]?.agency_surcharge}<br />
                      <strong>Disbursement Fee: </strong> {rows[0]?.disbursement_fee}<br />
                      <strong>Customs Clearing Fee: </strong> {rows[0]?.customs_clearing_fee}<br />
                    </td>
                  </tr>
                      <tr>
                      <td colSpan="10" className="text-end">
                      <strong>Final Amount: </strong> {rows[0]?.final_amount + finalAmount123333}<br />
                      </td>
                      </tr>
                </tbody>
              </table>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        ...
                        <input
                          type="text"
                          disabled
                          value={totalamount ? totalamount : RowData.total_amount}
                          placeholder="0102.29	"
                          name="total_amount"
                          onChange={handlechnagedata}
                        />
